  ...
  return (
    <div>
      <form className="new-grind-report-form" onSubmit={props.handleSubmit}>
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Start Time</label>
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">End Time</label>
        <input className="new-grind-report-input-box"
          type="text"
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Total Shots Made</label>
        <input className="new-grind-report-input-box"
          type="number"
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Total Threes Made</label>
        <input className="new-grind-report-input-box"
          type="number"
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Right Corner</label>
        <input className="new-grind-report-input-box"
          type="number"
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Left Corner</label>
        <input className="new-grind-report-input-box"
          type="number"
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Right Wing</label>
        <input className="new-grind-report-input-box"
          type="number"
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Left Wing</label>
        <input className="new-grind-report-input-box"
          type="number"
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Key</label>
        <input className="new-grind-report-input-box"
          type="number"
          value={props.keyy}
        ...
        />
        <br />
        <label className="form-elements" className="form-elements-totals">Shot Performance</label>
        <input className="new-grind-report-input-box"
